...
public class AdapterKhutbah extends RecyclerView.Adapter<AdapterKhutbah.ViewHolder> {

    Context context;
    public List<GSONsemuakhutbah.SemuaKhutbahList> khutbahLists;

    public AdapterKhutbah(Context context, List<GSONsemuakhutbah.SemuaKhutbahList> khutbahLists) {
        this.context = context;
        this.khutbahLists = khutbahLists;
    }

    @Override
    public AdapterKhutbah.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        TextDrawable drawable = builder.build(khutbahLists.get(position).huruf_depan_nama_ustad, colorRandom);
...
//                .into(holder.tvGambar_Ustad);
        ...
        holder.tvJudul.setText(khutbahLists.get(position).judul_khutbah);
        holder.tvNama_Ustad.setText(khutbahLists.get(position).nama_ustad);
        holder.tv_tema.setText(khutbahLists.get(position).nama_tema_khutbah);

        holder.tv_id.setText(khutbahLists.get(position).id_isi_khutbah);

        final String id_khutbah = khutbahLists.get(position).id_isi_khutbah;
        ...
        holder.card_item_list.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sendToDetail.putExtra(khutbahLists.get(position).id_isi_khutbah, id_khutbah);
