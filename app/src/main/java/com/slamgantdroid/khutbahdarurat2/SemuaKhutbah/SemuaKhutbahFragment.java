 ...
 */
public class SemuaKhutbahFragment extends Fragment {
    ...
    public static SemuaKhutbahFragment newInstance() {
        // Required empty public constructor
        return new SemuaKhutbahFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_semua_khutbah, container, false);

        url = "http://10.10.10.7/khutbah_darurat/listKhutbah.php";

        imgError = (ImageView)view.findViewById(R.id.imgerror);
        recyclerView = (RecyclerView)view.findViewById(R.id.recycler_semua_khutbah);
