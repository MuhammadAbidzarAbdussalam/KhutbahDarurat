 ...
 */
public class TarawihFragment extends Fragment {
    ...
    public static TarawihFragment newInstance() {
        // Required empty public constructor
        return new TarawihFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tarawih, container, false);

        imgError = (ImageView)view.findViewById(R.id.imgerror);
        recyclerView = (RecyclerView)view.findViewById(R.id.recycler_tarawih);
    ...
    private void loadData() {
        swipeRefreshLayout.setRefreshing(true);
        stringRequest = new StringRequest(Request.Method.POST, "http://10.10.10.7/khutbah_darurat/listTarawih.php", new Response.Listener<String>() {
            @Override
